...
if($ticketNumber!="")	$searchField.=" AND ticket_table.ticketNumber LIKE '%$ticketNumber%'";


$sqlTicket=mysql_query("SELECT * FROM ticket_table, event_table, officer_table WHERE ticket_table.eventId=event_table.eventId AND ticket_table.officerId=officer_table.officerId AND eventDelete='0' AND officerDelete='0' AND ticketDelete='0' $searchField ORDER BY ticketId DESC");
