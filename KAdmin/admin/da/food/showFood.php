...
$sqlFood=mysql_query("SELECT * FROM food_table, event_table WHERE food_table.eventId=event_table.eventId AND eventDelete='0' AND foodDelete='0' ORDER BY foodId DESC");
