...
$sqlTable=mysql_query("SELECT * FROM table_table, event_table WHERE table_table.eventId=event_table.eventId AND eventDelete='0' AND tableDelete='0' ORDER BY tableId DESC");
