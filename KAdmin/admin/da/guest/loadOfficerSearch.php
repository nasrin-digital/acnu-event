...
{
	echo'<select id="guestOfficerSearch" class="form-control" onChange="loadTicket();">
...
{
	echo'<select id="guestOfficerSearch" class="form-control"><option>Select</option></select>';
	exit;
}
?>