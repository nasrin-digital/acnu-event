...
if($tableId!=0)	$searchField.=" AND table_table.tableId='$tableId'";
if($seatName!="")	$searchField.=" AND  seat_table.seatName LIKE '%$seatName%'";


$sqlSeat=mysql_query("SELECT * FROM seat_table, event_table, table_table WHERE seat_table.eventId=event_table.eventId AND seat_table.tableId=table_table.tableId AND eventDelete='0' AND tableDelete='0' AND seatDelete='0' $searchField ORDER BY seatId DESC");
