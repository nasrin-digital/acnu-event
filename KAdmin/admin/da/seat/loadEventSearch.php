...
{
	echo'<select id="seatEventSearch" class="form-control" onChange="loadTableSearch();">
...
{
	echo'<select id="seatEventSearch" class="form-control"><option>Select</option></select>';
	exit;
}
?>